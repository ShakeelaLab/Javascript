...
/* Opdracht 2 */
// Schrijf een functie genaamd minutesToSeconds,
// die een hoeveelheid minuten verwacht (als een getal) en
// teruggeeft hoeveel seconden dat zijn.
// ---- Verwachte uitkomsten:
...
function minutesToSeconds(minutes) {
  const countMinutes = minutes * 60;
  return (countMinutes);
}

const countMinutes = minutesToSeconds(23);
console.log(countMinutes);

/* Opdracht 3 */
// Schrijf een functie genaamd merge,
// die twee strings verwacht en deze aan
// elkaar geplakt teruggeeft.
// Let op: je mag hier geen String methoden
...
const result1 = merge("abra", "cadabra");

console.log(result1);


/* Opdracht  4 */
// Schrijf een functie genaamd calculateDogYears
// die de hondenleeftijd verwacht en dit omrekent
// naar mensenjaren (1 tot 7). Op basis daarvan
// wordt een zinnetje teruggegeven.
// ---- Verwachte uitkomsten:
...
function calculateDogYears(age) {
  const ageDog = age * 7;
  return (`Jouw hond is ${ageDog} jaar oud in mensenjaren.`);
}
...
/* Opdracht 5 */
// Schrijf een functie genaamd wrapper, die twee
// parameters verwacht: een woord en een karakter
// De functie omwikkelt het woord met het karakter
// en geeft dit terug
// ---- Verwachte uitkomsten:
...
function wrapper(wordChoice,caracterChoise) {
  const resultWrapper = (`wrapper("${wordChoice}", "${caracterChoise}") geeft "${caracterChoise}${wordChoice}${caracterChoise}"`);{
...
/* Bonus opdracht  */
// Schrijf een functie genaamd createDetailString, die een object
// met de properties firstName, lastName en profession verwacht en
// een zin teruggeeft
// ---- Verwachte uitkomsten:
